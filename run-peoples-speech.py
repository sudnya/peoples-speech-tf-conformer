...
DEFAULT_YAML = os.path.join(os.path.abspath(os.path.dirname(__file__)), "peoples-speech-dataset-config.yml")

tf.keras.backend.clear_session()

parser = argparse.ArgumentParser(prog="Conformer Test for Peoples Speech")
...
test_dataset = PeoplesSpeechDataset(
